...
public class ProductService {
	...
	/**
	 * To return an array of products containing <code>limit</code> number of
	 * products, <b>FROM</b> <code>offset</code>
	 * 
	 * @param limit    number of products to return
	 * @param products having product ID after <code>offset</code> will be returned.
	 *                 The offset may start from 0
	 * 
	 * @return an array of products containing containing <code>limit</code> number
	 *         of products, <b>FROM</b> <code>offset</code>
	 * 
	 *         Example: limit = 10, offset = 0, will return products from ID 0 to ID
